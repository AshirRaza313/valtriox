...
const { compareCatalogs: compareEvolvedCatalogs } = require("./compare-evolved-catalogs.cjs");
const { APPROVED_TABLES, canonicalJson, sha256, structuralSha256 } = require("./catalog-contract.cjs");
const { APPROVED_TABLES: APPROVED_EVOLVED_TABLES } = require("./evolved-catalog-contract.cjs");
