    ...
    <tr>
      <td align="center">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#12121a;border:1px solid rgba(255,255,255,0.06);border-radius:16px;overflow:hidden;">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#1a1508 0%,#12121a 100%);padding:32px 32px 24px;border-bottom:1px solid rgba(211,166,56,0.15);">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="right">
                    <div style="display:inline-block;width:40px;height:40px;background:rgba(211,166,56,0.1);border:1px solid rgba(211,166,56,0.2);border-radius:10px;text-align:center;line-height:40px;font-size:18px;">
                      V
                    </div>
                  </td>
                </tr>
...
function buildSocialIconsHtml(links: SocialLinks): string {
  ...
  const iconStyle = "display:inline-block;width:36px;height:36px;border-radius:8px;background:rgba(211,166,56,0.1);border:1px solid rgba(211,166,56,0.2);text-align:center;line-height:36px;margin:0 4px;text-decoration:none;";
            ...
            <td style="background:linear-gradient(135deg,#1a1508 0%,#12121a 100%);padding:32px 32px 24px;border-bottom:1px solid rgba(211,166,56,0.15);">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="right">
                    <div style="display:inline-block;width:40px;height:40px;background:rgba(211,166,56,0.1);border:1px solid rgba(211,166,56,0.2);border-radius:10px;text-align:center;line-height:40px;font-size:18px;">&#9734;</div>
                  </td>
                </tr>
              </table>
            </td>
...
export function getLeadCaptureEmailHtml(data: LeadCaptureEmailData): string {
  ...
  if (data.instagramUrl) {
    socialIcons.push(`<a href="${data.instagramUrl}" target="_blank" rel="noopener noreferrer" style="display:inline-block;width:36px;height:36px;border-radius:8px;background:rgba(211,166,56,0.1);border:1px solid rgba(211,166,56,0.2);text-align:center;line-height:36px;margin:0 4px;text-decoration:none;" title="Instagram">
  ...
  if (data.linkedinUrl) {
    socialIcons.push(`<a href="${data.linkedinUrl}" target="_blank" rel="noopener noreferrer" style="display:inline-block;width:36px;height:36px;border-radius:8px;background:rgba(211,166,56,0.1);border:1px solid rgba(211,166,56,0.2);text-align:center;line-height:36px;margin:0 4px;text-decoration:none;" title="LinkedIn">
  ...
  if (data.discordUrl) {
    socialIcons.push(`<a href="${data.discordUrl}" target="_blank" rel="noopener noreferrer" style="display:inline-block;width:36px;height:36px;border-radius:8px;background:rgba(211,166,56,0.1);border:1px solid rgba(211,166,56,0.2);text-align:center;line-height:36px;margin:0 4px;text-decoration:none;" title="Discord">
  ...
  if (data.redditUrl) {
    socialIcons.push(`<a href="${data.redditUrl}" target="_blank" rel="noopener noreferrer" style="display:inline-block;width:36px;height:36px;border-radius:8px;background:rgba(211,166,56,0.1);border:1px solid rgba(211,166,56,0.2);text-align:center;line-height:36px;margin:0 4px;text-decoration:none;" title="Reddit">
            ...
            <td style="background:linear-gradient(135deg,#1a1508 0%,#12121a 100%);padding:32px 32px 24px;border-bottom:1px solid rgba(211,166,56,0.15);">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="right">
                    <div style="display:inline-block;width:40px;height:40px;background:rgba(211,166,56,0.1);border:1px solid rgba(211,166,56,0.2);border-radius:10px;text-align:center;line-height:40px;font-size:20px;">
                      &#10003;
                    </div>
                  </td>
                </tr>
            ...
            <td style="background:linear-gradient(135deg,#1a1508 0%,#12121a 100%);padding:32px 32px 24px;border-bottom:1px solid rgba(211,166,56,0.15);">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="right">
                    <div style="display:inline-block;width:40px;height:40px;background:rgba(211,166,56,0.1);border:1px solid rgba(211,166,56,0.2);border-radius:10px;text-align:center;line-height:40px;font-size:18px;">${icon}</div>
                  </td>
                </tr>
              </table>
            </td>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#151A26;min-height:100vh;padding:40px 16px;">
    <tr>
      <td align="center">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;background:#12121a;border:1px solid rgba(211,166,56,0.2);border-radius:20px;overflow:hidden;box-shadow:0 0 60px rgba(211,166,56,0.08);">

          <!-- Exclusive Header -->
          <tr>
            <td style="background:linear-gradient(135deg,rgba(211,166,56,0.15) 0%,#12121a 60%);padding:40px 36px 28px;border-bottom:1px solid rgba(211,166,56,0.2);">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td>
    ...
    <tr>
      <td align="center" style="padding:48px 16px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding:0 40px 8px;" align="center">
                    <table cellpadding="0" cellspacing="0" style="background:linear-gradient(145deg,#111827 0%,#08080d 100%);border:1.5px solid rgba(211,166,56,0.25);border-radius:18px;padding:28px 48px;">
                      <tr>
                        <td align="center">
          ...
          <tr>
            <td style="height:2px;background:linear-gradient(90deg,transparent 0%,rgba(211,166,56,0.3) 50%,transparent 100%);border-radius:0 0 3px 3px;"></td>
          </tr>
        </table>
