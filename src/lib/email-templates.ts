    ...
    <tr>
      <td align="center">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#12121a;border:1px solid rgba(255,255,255,0.06);border-radius:16px;overflow:hidden;">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#1a1508 0%,#12121a 100%);padding:32px 32px 24px;border-bottom:1px solid rgba(212,167,58,0.15);">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="right">
                    <div style="display:inline-block;width:40px;height:40px;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);border-radius:10px;text-align:center;line-height:40px;font-size:18px;">
                      V
                    </div>
                  </td>
                </tr>
          ...
          <tr>
            <td style="padding:28px 32px 0;" align="center">
              <a href="${data.joinUrl}" target="_blank" style="
                ...
                background:linear-gradient(135deg,#D4A73A 0%,#B8922E 100%);
                color:#161B26;
          ...
          <tr>
            <td style="padding:20px 32px 0;">
              <div style="background:rgba(212,167,58,0.06);border:1px solid rgba(212,167,58,0.12);border-radius:8px;padding:14px 18px;">
...
function buildSocialIconsHtml(links: SocialLinks): string {
  ...
  const iconStyle = "display:inline-block;width:36px;height:36px;border-radius:8px;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);text-align:center;line-height:36px;margin:0 4px;text-decoration:none;";
    ...
    <tr>
      <td align="center">
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#12121a;border:1px solid rgba(255,255,255,0.06);border-radius:16px;overflow:hidden;">
            ...
            <td style="background:linear-gradient(135deg,#1a1508 0%,#12121a 100%);padding:32px 32px 24px;border-bottom:1px solid rgba(212,167,58,0.15);">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="right">
                    <div style="display:inline-block;width:40px;height:40px;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);border-radius:10px;text-align:center;line-height:40px;font-size:18px;">&#9734;</div>
                  </td>
                </tr>
              </table>
            </td>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="vertical-align:top;">
                          <div style="width:24px;height:24px;border-radius:6px;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);text-align:center;line-height:24px;font-size:12px;font-weight:700;color:#D4A73A;">${i + 1}</div>
                        </td>
          ...
          <tr>
            <td style="padding:28px 32px 0;">
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#161B26;border:1px solid rgba(212,167,58,0.12);border-radius:12px;overflow:hidden;">
                <tr>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" style="padding-top:20px;">
                          <a href="${data.platformWebsite}" target="_blank" style="display:inline-block;background:linear-gradient(135deg,#D4A73A 0%,#B8922E 100%);color:#161B26;text-decoration:none;font-size:15px;font-weight:700;padding:14px 40px;border-radius:10px;">Choose Your Plan</a>
                        </td>
                      </tr>
                    </table>
                  </td>
    ...
    <tr>
      <td align="center">
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#12121a;border:1px solid rgba(255,255,255,0.06);border-radius:16px;overflow:hidden;">
                ...
                <tr>
                  <td style="padding:14px 20px;border-bottom:1px solid rgba(255,255,255,0.04);">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="vertical-align:top;">
                          <div style="width:24px;height:24px;border-radius:50%;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);text-align:center;line-height:24px;font-size:11px;font-weight:700;color:#D4A73A;">${step.n}</div>
                        </td>
                        <td style="padding-left:14px;font-size:14px;color:#e5e7eb;line-height:1.5;">${step.t}</td>
                      </tr>
                    </table>
          ...
          <tr>
            <td style="padding:28px 32px 0;" align="center">
              <a href="${data.loginUrl}" target="_blank" style="display:inline-block;background:linear-gradient(135deg,#D4A73A 0%,#B8922E 100%);color:#161B26;text-decoration:none;font-size:15px;font-weight:700;padding:14px 40px;border-radius:10px;">Access Your Dashboard</a>
            </td>
          </tr>
    ...
    <tr>
      <td align="center">
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#12121a;border:1px solid rgba(255,255,255,0.06);border-radius:16px;overflow:hidden;">
                ...
                <tr>
                  <td style="padding:14px 20px;border-bottom:1px solid rgba(255,255,255,0.04);">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="vertical-align:top;">
                          <div style="width:24px;height:24px;border-radius:6px;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);text-align:center;line-height:24px;font-size:12px;font-weight:700;color:#D4A73A;">${step.n}</div>
                        </td>
                        <td style="padding-left:14px;font-size:14px;color:#e5e7eb;line-height:1.5;">${step.t}</td>
                      </tr>
                    </table>
          ...
          <tr>
            <td style="padding:28px 32px 0;" align="center">
              <a href="${data.dashboardUrl}" target="_blank" style="display:inline-block;background:linear-gradient(135deg,#D4A73A 0%,#B8922E 100%);color:#161B26;text-decoration:none;font-size:15px;font-weight:700;padding:14px 40px;border-radius:10px;">Go to Dashboard</a>
            </td>
          </tr>
    ...
    <tr>
      <td align="center">
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#12121a;border:1px solid rgba(255,255,255,0.06);border-radius:16px;overflow:hidden;">
            ...
            <td style="background:linear-gradient(135deg,#1a1508 0%,#12121a 100%);padding:32px 32px 24px;border-bottom:1px solid rgba(212,167,58,0.15);">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="right">
                    <div style="display:inline-block;width:40px;height:40px;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);border-radius:10px;text-align:center;line-height:40px;font-size:18px;color:#D4A73A;">&#128196;</div>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding:28px 32px 0;" align="center">
              <a href="${data.proposalViewUrl}" target="_blank" style="display:inline-block;background:linear-gradient(135deg,#D4A73A 0%,#B8922E 100%);color:#161B26;text-decoration:none;font-size:15px;font-weight:700;padding:14px 40px;border-radius:10px;">View Proposal</a>
            </td>
          </tr>
    ...
    <tr>
      <td align="center">
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#12121a;border:1px solid rgba(255,255,255,0.06);border-radius:16px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:28px 32px 0;" align="center">
              <a href="${data.invoiceDownloadUrl}" target="_blank" style="display:inline-block;background:linear-gradient(135deg,#D4A73A 0%,#B8922E 100%);color:#161B26;text-decoration:none;font-size:15px;font-weight:700;padding:14px 40px;border-radius:10px;">Download Invoice</a>
            </td>
          </tr>
...
export function getLeadCaptureEmailHtml(data: LeadCaptureEmailData): string {
  ...
  if (data.instagramUrl) {
    socialIcons.push(`<a href="${data.instagramUrl}" target="_blank" rel="noopener noreferrer" style="display:inline-block;width:36px;height:36px;border-radius:8px;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);text-align:center;line-height:36px;margin:0 4px;text-decoration:none;" title="Instagram">
  ...
  if (data.linkedinUrl) {
    socialIcons.push(`<a href="${data.linkedinUrl}" target="_blank" rel="noopener noreferrer" style="display:inline-block;width:36px;height:36px;border-radius:8px;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);text-align:center;line-height:36px;margin:0 4px;text-decoration:none;" title="LinkedIn">
  ...
  if (data.discordUrl) {
    socialIcons.push(`<a href="${data.discordUrl}" target="_blank" rel="noopener noreferrer" style="display:inline-block;width:36px;height:36px;border-radius:8px;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);text-align:center;line-height:36px;margin:0 4px;text-decoration:none;" title="Discord">
  ...
  if (data.redditUrl) {
    socialIcons.push(`<a href="${data.redditUrl}" target="_blank" rel="noopener noreferrer" style="display:inline-block;width:36px;height:36px;border-radius:8px;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);text-align:center;line-height:36px;margin:0 4px;text-decoration:none;" title="Reddit">
            ...
            <td style="background:linear-gradient(135deg,#1a1508 0%,#12121a 100%);padding:32px 32px 24px;border-bottom:1px solid rgba(212,167,58,0.15);">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="right">
                    <div style="display:inline-block;width:40px;height:40px;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);border-radius:10px;text-align:center;line-height:40px;font-size:20px;">
                      &#10003;
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:14px 20px;border-bottom:1px solid rgba(255,255,255,0.04);">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="vertical-align:top;">
                          <div style="width:24px;height:24px;border-radius:6px;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);text-align:center;line-height:24px;font-size:12px;font-weight:700;color:#D4A73A;flex-shrink:0;">
                            ${step.num}
                          </div>
                        </td>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#12121a;border:1px solid rgba(255,255,255,0.06);border-radius:16px;overflow:hidden;">
                ...
                <tr>
                  <td style="padding:14px 20px;border-bottom:1px solid rgba(255,255,255,0.04);">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="vertical-align:top;">
                          <div style="width:24px;height:24px;border-radius:6px;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);text-align:center;line-height:24px;font-size:12px;font-weight:700;color:#D4A73A;">${q.n}</div>
                        </td>
          ...
          <tr>
            <td style="padding:28px 32px 0;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#161B26;border:1px solid rgba(212,167,58,0.12);border-radius:12px;overflow:hidden;">
                <tr>
                  <td style="padding:14px 16px;background:rgba(212,167,58,0.06);border-bottom:1px solid rgba(212,167,58,0.12);font-size:11px;color:#D4A73A;text-transform:uppercase;letter-spacing:1px;font-weight:700;">Plan</td>
                  <td style="padding:14px 16px;background:rgba(212,167,58,0.06);border-bottom:1px solid rgba(212,167,58,0.12);font-size:11px;color:#D4A73A;text-transform:uppercase;letter-spacing:1px;font-weight:700;">Price</td>
                  <td style="padding:14px 16px;background:rgba(212,167,58,0.06);border-bottom:1px solid rgba(212,167,58,0.12);font-size:11px;color:#D4A73A;text-transform:uppercase;letter-spacing:1px;font-weight:700;">Best For</td>
                </tr>
                <tr>
          ...
          <tr>
            <td style="padding:28px 32px 0;" align="center">
              <a href="${data.consultationUrl}" target="_blank" style="display:inline-block;background:linear-gradient(135deg,#D4A73A 0%,#B8922E 100%);color:#161B26;text-decoration:none;font-size:15px;font-weight:700;padding:14px 40px;border-radius:10px;">Schedule Free Consultation</a>
            </td>
          </tr>
            ...
            <td style="background:linear-gradient(135deg,#1a1508 0%,#12121a 100%);padding:32px 32px 24px;border-bottom:1px solid rgba(212,167,58,0.15);">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="right">
                    <div style="display:inline-block;width:40px;height:40px;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);border-radius:10px;text-align:center;line-height:40px;font-size:18px;">${icon}</div>
                  </td>
                </tr>
              </table>
            </td>
...
<tr><td style="padding:20px 32px 0;"><div style="background:rgba(212,167,58,0.06);border:1px solid rgba(212,167,58,0.12);border-radius:8px;padding:14px 18px;">
...
<tr><td style="padding:28px 32px 0;" align="center">
  <a href="${data.platformWebsite}" target="_blank" style="display:inline-block;background:linear-gradient(135deg,#D4A73A 0%,#B8922E 100%);color:#161B26;text-decoration:none;font-size:15px;font-weight:700;padding:14px 40px;border-radius:10px;">Get Started</a>
</td></tr>
...
<tr><td style="padding:24px 32px 0;">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#161B26;border:1px solid rgba(255,255,255,0.06);border-radius:12px;overflow:hidden;">
    <tr><td style="padding:14px 20px;border-bottom:1px solid rgba(255,255,255,0.04);"><table width="100%" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;"><div style="width:24px;height:24px;border-radius:6px;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);text-align:center;line-height:24px;font-size:12px;font-weight:700;color:#D4A73A;">1</div></td><td style="padding-left:14px;font-size:14px;color:#e5e7eb;line-height:1.5;">Reply to this email with your preferred date and time</td></tr></table></td></tr>
    ...
    <tr><td style="padding:14px 20px;"><table width="100%" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;"><div style="width:24px;height:24px;border-radius:6px;background:rgba(212,167,58,0.1);border:1px solid rgba(212,167,58,0.2);text-align:center;line-height:24px;font-size:12px;font-weight:700;color:#D4A73A;">3</div></td><td style="padding-left:14px;font-size:14px;color:#e5e7eb;line-height:1.5;">Mention your preferred consultation method (video, phone, in-person)</td></tr></table></td></tr>
  </table>
</td></tr>
<tr><td style="padding:24px 32px 0;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#161B26;border:1px solid rgba(255,255,255,0.06);border-radius:12px;overflow:hidden;">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#161B26;min-height:100vh;padding:40px 16px;">
    <tr>
      <td align="center">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;background:#12121a;border:1px solid rgba(212,167,58,0.2);border-radius:20px;overflow:hidden;box-shadow:0 0 60px rgba(212,167,58,0.08);">

          <!-- Exclusive Header -->
          <tr>
            <td style="background:linear-gradient(135deg,rgba(212,167,58,0.15) 0%,#12121a 60%);padding:40px 36px 28px;border-bottom:1px solid rgba(212,167,58,0.2);">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td>
                  ...
                  <td align="right" valign="top">
                    <div style="display:inline-block;width:48px;height:48px;background:linear-gradient(135deg,#D4A73A 0%,#B8922E 100%);border-radius:14px;text-align:center;line-height:48px;font-size:22px;font-weight:800;color:#161B26;">
                      V
                    </div>
                  </td>
                </tr>
          ...
          <tr>
            <td style="padding:24px 36px 0;" align="center">
              <table width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg,rgba(212,167,58,0.1) 0%,rgba(212,167,58,0.03) 100%);border:1px solid rgba(212,167,58,0.15);border-radius:12px;">
                <tr>
          ...
          <tr>
            <td style="padding:24px 36px 0;">
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#161B26;border:1px solid rgba(212,167,58,0.12);border-radius:14px;overflow:hidden;">
                <tr>
                  <td style="padding:20px 24px;border-bottom:1px solid rgba(212,167,58,0.08);">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:8px;">
                      <tr>
                        <td style="width:20px;vertical-align:top;">
                          <div style="width:18px;height:18px;border-radius:50%;background:rgba(212,167,58,0.15);border:1px solid rgba(212,167,58,0.3);text-align:center;line-height:18px;font-size:10px;color:#D4A73A;">&#10003;</div>
                        </td>
          ...
          <tr>
            <td style="padding:20px 36px 0;">
              <div style="background:rgba(212,167,58,0.06);border:1px solid rgba(212,167,58,0.1);border-radius:10px;padding:14px 18px;">
    ...
    <tr>
      <td align="center" style="padding:48px 16px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;">
          ...
          <!-- Main card -->
          <tr>
            <td style="background:linear-gradient(165deg,#1C2333 0%,#0c0c12 50%,#161B26 100%);border:1px solid rgba(212,167,58,0.1);border-top:none;border-radius:0 0 20px 20px;overflow:hidden;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding:0 40px 8px;" align="center">
                    <table cellpadding="0" cellspacing="0" style="background:linear-gradient(145deg,#111827 0%,#08080d 100%);border:1.5px solid rgba(212,167,58,0.25);border-radius:18px;padding:28px 48px;">
                      <tr>
                        <td align="center">
                          ...
                          <div style="font-size:42px;font-weight:800;color:#D4A73A;font-family:'SF Mono','Fira Code','Courier New',monospace;letter-spacing:14px;text-shadow:0 0 30px rgba(212,167,58,0.15);">
                            ${data.otp}
                          </div>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding:28px 40px 0;">
                    <table width="100%" cellpadding="0" cellspacing="0" style="background:rgba(212,167,58,0.04);border:1px solid rgba(212,167,58,0.08);border-radius:12px;">
                      <tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding:36px 40px 16px;text-align:center;">
                    <div style="width:60px;height:1px;background:linear-gradient(90deg,transparent,rgba(212,167,58,0.2),transparent);margin:0 auto 20px;"></div>
          ...
          <tr>
            <td style="height:2px;background:linear-gradient(90deg,transparent 0%,rgba(212,167,58,0.3) 50%,transparent 100%);border-radius:0 0 3px 3px;"></td>
          </tr>
        </table>
