  ...
  const fetchIdentity = async () => {
    try {
      ...
      if (res.ok) {
        ...
        const mapped: PlatformIdentity = {
          ...
          companyEmail: data.companyEmail || process.env.NEXT_PUBLIC_SUPPORT_EMAIL || "support@valtriox.com",
    ...
    try {
      ...
      const mapped: PlatformIdentity = {
        ...
        companyEmail: s.companyEmail || process.env.NEXT_PUBLIC_SUPPORT_EMAIL || "support@valtriox.com",
