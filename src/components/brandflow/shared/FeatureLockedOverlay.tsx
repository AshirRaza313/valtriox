    ...
    >
      <motion.div
        ...
        style={{
          ...
          border: isGold
            ? "1px solid rgba(211,166,56,0.2)"
            : "1px solid rgba(16,185,129,0.2)",
          boxShadow: isGold
            ? "0 25px 60px rgba(0,0,0,0.5), 0 0 80px rgba(211,166,56,0.08)"
      ...
      >
        ...
        <div
          ...
          style={{
            boxShadow: isGold
              ? "inset 0 1px 0 rgba(211,166,56,0.15), 0 4px 20px rgba(211,166,56,0.1)"
        ...
        <div className="text-left mb-6 rounded-xl p-4" style={{
          background: isGold ? "rgba(211,166,56,0.04)" : "rgba(16,185,129,0.04)",
          border: isGold ? "1px solid rgba(211,166,56,0.08)" : "1px solid rgba(16,185,129,0.08)",
        }}>
          <p
