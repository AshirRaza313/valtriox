                ...
                <AreaChart data={data} margin={{ top: 8, right: 4, left: -8, bottom: 0 }}>
                  <defs>
                    <linearGradient id="revenueGradient" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0%" stopColor={isGold ? "#d4a017" : "#f59e0b"} stopOpacity={0.35} />
                      <stop offset="60%" stopColor={isGold ? "#d4a017" : "#f59e0b"} stopOpacity={0.08} />
                      <stop offset="100%" stopColor={isGold ? "#d4a017" : "#f59e0b"} stopOpacity={0} />
                    </linearGradient>
                    <linearGradient id="lineGradient" x1="0" y1="0" x2="1" y2="0">
                      <stop offset="0%" stopColor={isGold ? "#d4a017" : "#f59e0b"} />
                      <stop offset="50%" stopColor={isGold ? "#f5c842" : "#fbbf24"} />
                      <stop offset="100%" stopColor={isGold ? "#d4a017" : "#f59e0b"} />
                    </linearGradient>
                  </defs>
                  <CartesianGrid
                    strokeDasharray="3 3"
                  ...
                  <Tooltip
                    ...
                    cursor={{
                      stroke: isGold ? "rgba(212,160,23,0.3)" : "rgba(245,158,11,0.3)",
                      strokeWidth: 1,
                      strokeDasharray: "4 4",
                    }}
                  />
