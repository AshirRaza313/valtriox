        ...
        >
          {isGold ? (
            <div className="relative rounded-xl p-px bg-gradient-to-br from-amber-500/30 via-transparent to-amber-500/20 group">
              <Card
                className={`kpi-gold-shimmer overflow-hidden transition-all duration-300 bg-white/[0.03] border-0 border-t-2 border-t-amber-500/30 backdrop-blur-sm hover:bg-white/[0.06] hover:shadow-[0_4px_24px_rgba(211,166,56,0.12)]`}
              >
