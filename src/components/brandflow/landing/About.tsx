...
export function About() {
  ...
  return (
    <section id="about" className="relative bg-[#0a0a0f] py-24 sm:py-32">
      {/* Background accents */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(212,160,23,0.04),transparent_70%)]" />
