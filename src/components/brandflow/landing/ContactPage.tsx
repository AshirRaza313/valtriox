    ...
    return (
      <div className="min-h-screen bg-[#0a0a0f] flex flex-col">
        ...
        <section className="relative pt-24 pb-12 sm:pt-32 sm:pb-16">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(212,160,23,0.12),transparent_60%)]" />
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <section className="relative pt-28 pb-16 sm:pt-32 sm:pb-20">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(212,160,23,0.08),transparent_60%)]" />
