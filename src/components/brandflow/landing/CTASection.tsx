    ...
    <section className="py-24 bg-[#161B26]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(212,167,58,0.15),transparent_50%)]" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,rgba(212,167,58,0.08),transparent_50%)]" />
          ...
          <div className="relative z-10">
            ...
            <div className="mt-10">
              <Button
                ...
                className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white font-semibold text-lg px-10 h-14 rounded-xl shadow-[0_0_30px_rgba(212,167,58,0.3)] hover:shadow-[0_0_40px_rgba(212,167,58,0.4)] transition-all duration-300"
              >
                Get Started Today
