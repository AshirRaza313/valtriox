...
export function SocialProof() {
  return (
    <section className="py-16 bg-[#151A26] overflow-hidden">
      ...
      <div className="relative">
        <div className="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-[#151A26] to-transparent z-10" />
        <div className="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-[#151A26] to-transparent z-10" />
