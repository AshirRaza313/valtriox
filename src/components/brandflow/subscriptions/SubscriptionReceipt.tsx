      ...
      <head>
        ...
        <style>
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .plan-card { background: #FAFAFA; border: 1px solid #e5e7eb; border-radius: 8px; padding: 20px; margin-bottom: 24px; }
          ...
          .footer { text-align: center; padding: 24px 32px; border-top: 1px solid #f3f4f6; background: #FAFAFA; }
