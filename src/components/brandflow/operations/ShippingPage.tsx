...
export function ShippingPage() {
  ...
  const cardBg = isGold ? "bg-[#111118] border-white/8" : isDark ? "bg-white/[0.03] border-white/[0.06]" : "bg-white border-slate-200";
  ...
  return (
    <div className="space-y-6">
      ...
      <Dialog open={shipmentOpen} onOpenChange={setShipmentOpen}>
        <DialogContent className={cn("max-w-[calc(100vw-2rem)] sm:max-w-lg", isDark ? "bg-[#15151e] border-white/10" : "")}>
          <DialogHeader>
