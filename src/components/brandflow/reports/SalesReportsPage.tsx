...
const PIE_COLORS = ["#D3A638", "#f59e0b", "#ef4444", "#8b5cf6", "#f97316", "#06b6d4", "#ec4899"];
                ...
                <AreaChart data={data.dailyBreakdown} margin={{ top: 5, right: 10, left: 10, bottom: 0 }}>
                  <defs>
                    <linearGradient id="revenueGradient" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor={isGold ? "#f59e0b" : "#D3A638"} stopOpacity={0.3} />
                      <stop offset="95%" stopColor={isGold ? "#f59e0b" : "#D3A638"} stopOpacity={0} />
                    </linearGradient>
                  </defs>
                  ...
                  <Area
                    type="monotone"
                    dataKey="revenue"
                    stroke={isGold ? "#f59e0b" : "#D3A638"}
                    strokeWidth={2}
                    fill="url(#revenueGradient)"
                    dot={data.dailyBreakdown.length <= 31}
                    activeDot={{ r: 5, fill: isGold ? "#f59e0b" : "#D3A638", strokeWidth: 0 }}
                  />
                </AreaChart>
              </ResponsiveContainer>
            </CardContent>
