        ...
        <CardContent className="p-4">
          <Tabs defaultValue="all" onValueChange={(v) => {}}>
            <TabsList className={cn(
              ...
              <TabsTrigger value="all" className="gap-1.5 data-[state=active]:bg-[#C9A227] data-[state=active]:text-black">
                All
                {stats.total > 0 && (
                  <span className={cn(
              ...
              <TabsTrigger value="upcoming" className="gap-1.5 data-[state=active]:bg-[#C9A227] data-[state=active]:text-black">
                Upcoming
                {stats.upcoming > 0 && (
                  <span className={cn(
                    "ml-1 text-[10px] px-1.5 py-0.5 rounded-full",
              ...
              <TabsTrigger value="overdue" className="gap-1.5 data-[state=active]:bg-[#C9A227] data-[state=active]:text-black">
                Overdue
                {stats.overdue > 0 && (
                  <span className={cn(
              ...
              <TabsTrigger value="followUpDue" className="gap-1.5 data-[state=active]:bg-[#C9A227] data-[state=active]:text-black">
                Follow-up Due
                {stats.followUpDue > 0 && (
                  <span className={cn(
