...
const PIE_COLORS = ["#D3A638", "#D3A638", "#8b5cf6", "#ec4899", "#06b6d4", "#f59e0b"];
                  ...
                  <div className="h-[280px]">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={revenueByClient} margin={{ top: 5, right: 20, left: 20, bottom: 5 }}>
                        ...
                        />
                        <Bar dataKey="revenue" fill={isGold ? "#D3A638" : "#D3A638"} radius={[4, 4, 0, 0]} />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                ) : (
                          ...
                          <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={revenueData.revenueByService.slice(0, 6)} layout="vertical" margin={{ top: 5, right: 20, left: 10, bottom: 5 }}>
                              ...
                              <Tooltip
                                ...
                                formatter={(v: number) => [`Rs. ${v.toLocaleString()}`, "Revenue"]}
                              />
                              <Bar dataKey="revenue" fill={isGold ? "#D3A638" : "#D3A638"} radius={[0, 4, 4, 0]} />
                            </BarChart>
                          </ResponsiveContainer>
                        </div>
                      ) : (
