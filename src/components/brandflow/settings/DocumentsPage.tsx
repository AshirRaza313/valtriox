...
.rte-content h1{font-size:1.5em;font-weight:700;margin:0.5em 0 0.3em;color:#C9A227}
...
.rte-content li::marker{color:#C9A227}
.rte-content blockquote{border-left:3px solid #C9A227;padding-left:1em;margin:0.5em 0;color:#94a3b8;font-style:italic}
...
.rte-content a{color:#C9A227;text-decoration:underline;word-break:break-all}
...
.rte-content input[type="checkbox"]{margin-right:8px;pointer-events:none;accent-color:#C9A227}
`;
  }
  return `
.rte-content{word-break:break-word;overflow-wrap:break-word;max-width:100%}
    ...
    >
      ...
      <div className="relative">
        ...
        <div
          ...
          style={{ caretColor: isDark ? "#C9A227" : undefined }}
        />
      </div>
    </div>
  );
