  ...
  return (
    <div className="space-y-5">
      ...
      <Dialog open={inviteOpen} onOpenChange={setInviteOpen}>
        <DialogContent className={cn("sm:max-w-lg max-h-[90vh] overflow-y-auto", isDark ? "bg-[#15151e] border-white/10" : "")}>
          <DialogHeader>
      ...
      <Dialog open={editRoleOpen} onOpenChange={setEditRoleOpen}>
        <DialogContent className={cn("sm:max-w-md", isDark ? "bg-[#15151e] border-white/10" : "")}>
          <DialogHeader>
