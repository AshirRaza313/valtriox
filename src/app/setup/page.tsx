...
export default function SetupPage() {
  ...
  if (step === "done") {
    return (
      <div className="min-h-screen bg-[#161B26] flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-[#1D2437] border border-[rgba(217,119,6,0.15)] rounded-2xl p-8 text-center">
  ...
  if (step === "configuring") {
    return (
      <div className="min-h-screen bg-[#161B26] flex items-center justify-center p-4">
        <div className="max-w-lg w-full bg-[#1D2437] border border-[rgba(217,119,6,0.15)] rounded-2xl p-8">
  ...
  return (
    <div className="min-h-screen bg-[#161B26] flex items-center justify-center p-4">
      <div className="max-w-xl w-full">
        ...
        {/* Card */}
        <div className="bg-[#1D2437] border border-[rgba(217,119,6,0.15)] rounded-2xl p-8">
          {/* Step 1: Database URL */}
          <div className="mb-6">
