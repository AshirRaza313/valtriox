    ...
    return (
      <div className="min-h-screen bg-[#151A26] flex items-center justify-center p-4">
        <div className="max-w-lg w-full bg-[#1C2333] border border-[rgba(217,119,6,0.15)] rounded-2xl p-8">
          ...
          <div className="bg-[#151A26] rounded-xl p-4 h-64 overflow-y-auto font-mono text-xs">
            {logs.map((log, i) => (
        ...
        <div className="bg-[#1C2333] border border-[rgba(217,119,6,0.15)] rounded-2xl p-8">
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-[#151A26] border border-[rgba(217,119,6,0.15)] rounded-xl text-white text-sm placeholder-gray-600 focus:outline-none focus:border-amber-500/40"
            />
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-3 bg-[#151A26] border border-[rgba(217,119,6,0.15)] rounded-xl text-white text-sm placeholder-gray-600 focus:outline-none focus:border-amber-500/40"
              />
              <button
                type="button"
          ...
          {/* Copy env vars */}
          <div className="mt-6 p-4 bg-[#151A26] rounded-xl">
