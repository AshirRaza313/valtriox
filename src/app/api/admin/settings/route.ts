...
const DEFAULT_SETTINGS = {
  ...
  currencySymbol: "Rs.",
  customCss: "",
  tagline: "Premium Brand Management Portal",
  emailFooterText: "",
  invoiceHeaderText: "",
};
...
function formatRow(row: any) {
  return {
    ...
    primaryBrandColor: row.primaryBrandColor || "#C9A227",
    secondaryBrandColor: row.secondaryBrandColor || "#C9A227",
    ...
    tagline: row.tagline || "Premium Brand Management Portal",
