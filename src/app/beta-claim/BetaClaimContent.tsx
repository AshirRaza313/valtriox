          ...
          <div className="relative p-8 pb-0 text-center overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <motion.div
                ...
                className="w-20 h-20 mx-auto mb-5 rounded-2xl bg-gradient-to-br from-amber-500 to-amber-700 shadow-lg shadow-amber-500/20 flex items-center justify-center overflow-hidden"
              >
                <img src="/valtriox-logo.png" alt="Valtriox" className="w-full h-full object-contain rounded-2xl p-1" />
              </motion.div>
            ...
            <AnimatePresence mode="wait">
              ...
              {step === "verify" && (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full h-12 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-[#0a0a0f] font-bold text-sm flex items-center justify-center gap-2 transition-all disabled:opacity-40 disabled:cursor-not-allowed shadow-lg shadow-amber-500/20 hover:shadow-amber-500/30"
                  >
                    {loading ? (
              ...
              {step === "success" && (
                ...
                >
                  ...
                  <Link
                    href="/"
                    className="inline-flex items-center justify-center gap-2 h-12 px-10 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-[#0a0a0f] font-bold text-sm transition-all shadow-lg shadow-amber-500/20 hover:shadow-amber-500/30"
                  >
                    Go to Dashboard
                    <ArrowRight className="h-4 w-4" />
                  </Link>
